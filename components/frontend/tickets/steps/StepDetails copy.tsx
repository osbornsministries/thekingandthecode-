// components/frontend/tickets/steps/StepDetails.tsx (Updated)
          ...
          <>
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500 bg-white/50"
