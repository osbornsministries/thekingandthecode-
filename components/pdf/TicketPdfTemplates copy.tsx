...
    width: 66 * SCALE_FACTOR, 
    height: 66 * SCALE_FACTOR, 
...
        
        {/* Ticket Type - Right Top (Restored) */}
        <Text style={styles.typeOverlay}>{ticket.type || 'TICKET'}</Text>
        
        {/* Session Name - Center Top (Restored) */}
        <Text style={styles.timeOverlay}>{sessionName}</Text>

        {/* Ticket Code - Bottom Center (Restored) */}
...
    qrOverlay: { ...styles.qrOverlay, width: 80, height: 80, padding: 5, left: 10 },
  });
  
...
                  <Text style={styles.gridText}>{String(type)}</Text>
                  {/* Ticket Code (Restored) */}
                  <Text style={styles.gridSubText}>{String(code).slice(0, 12)}</Text>
                </View>
              );
            })}
          </View>
